...
oc_train_data = np.load("/mnt/d/BaiduNetdiskWorkspace/OneDrive/work/VADER/VADERdata/processed_NC_9.npy")
oc_train_label = np.load("/mnt/d/BaiduNetdiskWorkspace/OneDrive/work/VADER/VADERdata/processed_NC_9_label.npy")
...
compare_clustering_methods(X_svd, oc_train_label, n_clusters=9, outputfile='results_svd_processed.csv')
compare_clustering_methods(oc_train_data, oc_train_label, n_clusters=9, outputfile='results_original_processed.csv')
